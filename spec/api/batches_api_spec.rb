...
# Unit tests for OpenapiClient::BatchesApi
...
describe 'BatchesApi' do
  ...
  describe 'test an instance of BatchesApi' do
    it 'should create an instance of BatchesApi' do
      expect(@api_instance).to be_instance_of(OpenapiClient::BatchesApi)
    end
  end
  ...
  # unit tests for find_batch_by_id
  # Retrieve a Batch
  # Returns a Batch
  # @param id Batch UUID
  # @param [Hash] opts the optional parameters
  ...
  # @return [Batch]
  describe 'find_batch_by_id test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
