...
class SpotMarketPricesList(object):
    ...
    def __init__(self, spot_market_prices=None, local_vars_configuration=None):  # noqa: E501
        """SpotMarketPricesList - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._spot_market_prices = None
        self.discriminator = None

        if spot_market_prices is not None:
            self.spot_market_prices = spot_market_prices

    @property
    def spot_market_prices(self):
        """Gets the spot_market_prices of this SpotMarketPricesList.  # noqa: E501


        :return: The spot_market_prices of this SpotMarketPricesList.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpotMarketPricesList):
            return False
