...
class SpotMarketRequestList(object):
    ...
    def __init__(self, spot_market_requests=None, local_vars_configuration=None):  # noqa: E501
        """SpotMarketRequestList - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration.get_default_copy()
        self.local_vars_configuration = local_vars_configuration

        self._spot_market_requests = None
        self.discriminator = None

        if spot_market_requests is not None:
            self.spot_market_requests = spot_market_requests

    @property
    def spot_market_requests(self):
        """Gets the spot_market_requests of this SpotMarketRequestList.  # noqa: E501


        :return: The spot_market_requests of this SpotMarketRequestList.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SpotMarketRequestList):
            return False
