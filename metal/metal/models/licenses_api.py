...
class LicensesApi(object):
    ...
    def delete_license(self, id, **kwargs):  # noqa: E501
    ...
    def delete_license_with_http_info(self, id, **kwargs):  # noqa: E501
        """Delete the license  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `delete_license`")  # noqa: E501
    ...
    def find_license_by_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.find_license_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.find_license_by_id_with_http_info(id, **kwargs)  # noqa: E501

    def find_license_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Retrieve a license  # noqa: E501
        ...
        >>> thread = api.find_license_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method find_license_by_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `find_license_by_id`")  # noqa: E501
    ...
    def update_license(self, id, license, **kwargs):  # noqa: E501
        ...
        >>> thread = api.update_license(id, license, async_req=True)
        >>> result = thread.get()

        :param id: License UUID (required)
        :type id: str
        :param license: License to update (required)
        :type license: LicenseUpdateInput
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.update_license_with_http_info(id, license, **kwargs)  # noqa: E501

    def update_license_with_http_info(self, id, license, **kwargs):  # noqa: E501
        """Update the license  # noqa: E501
        ...
        >>> thread = api.update_license_with_http_info(id, license, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
                                                        local_var_params['id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `id` when calling `update_license`")  # noqa: E501
        # verify the required parameter 'license' is set
        if self.api_client.client_side_validation and ('license' not in local_var_params or  # noqa: E501
                                                        local_var_params['license'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `license` when calling `update_license`")  # noqa: E501
