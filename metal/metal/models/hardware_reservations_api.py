...
class HardwareReservationsApi(object):
    ...
    def find_hardware_reservation_by_id(self, id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.find_hardware_reservation_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        return self.find_hardware_reservation_by_id_with_http_info(id, **kwargs)  # noqa: E501

    def find_hardware_reservation_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Retrieve a hardware reservation  # noqa: E501
        ...
        >>> thread = api.find_hardware_reservation_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method find_hardware_reservation_by_id" % key
                )
        ...
        if self.api_client.client_side_validation and ('id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `id` when calling `find_hardware_reservation_by_id`")  # noqa: E501
    ...
    def hardware_reservations_id_move_post_with_http_info(self, id, project_id, **kwargs):  # noqa: E501
        ...
        if 'project_id' in local_var_params:
            body_params = local_var_params['project_id']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
