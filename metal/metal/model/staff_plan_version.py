...
class StaffPlanVersion(ModelNormal):
    ...
    attribute_map = {
        ...
        'preinstallable': 'preinstallable',  # noqa: E501
        'plan': 'plan',  # noqa: E501
