...
class PaymentMethodUpdateInput(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'billing_address': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)},),  # noqa: E501
        }
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            expiration_year (int): [optional]  # noqa: E501
            billing_address ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}): [optional]  # noqa: E501
        """
