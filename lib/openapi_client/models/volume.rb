  ...
  class Volume
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'snapshot_policies')
        if (value = attributes[:'snapshot_policies']).is_a?(Array)
          self.snapshot_policies = value
        end
      end
    ...
    def hash
      [id, name, description, size, locked, billing_cycle, state, created_at, updated_at, project, facility, snapshot_policies, attachments, plan, href, customdata].hash
    end
