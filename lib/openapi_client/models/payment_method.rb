...
module OpenapiClient
  class PaymentMethod
    ...
    def hash
      [id, name, type, default, created_at, updated_at, card_type, expiration_month, expiration_year, cardholder_name, billing_address, email, created_by_user, organization, projects].hash
    end
