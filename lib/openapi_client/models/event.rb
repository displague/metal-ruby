...
module OpenapiClient
  class Event
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'interpolated')
        self.interpolated = attributes[:'interpolated']
      end
    ...
    def hash
      [id, state, type, body, relationships, interpolated, created_at, href].hash
    end
