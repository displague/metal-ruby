...
with metal.ApiClient(configuration) as api_client:
    ...
    api_instance = metal.MembershipsApi(api_client)
...
per_page = 10 # int | Items returned per page (optional) (default to 10)
    ...
    try:
        ...
        print("Exception when calling MembershipsApi->find_project_memberships: %s\n" % e)
```
...
with metal.ApiClient(configuration) as api_client:
    ...
    api_instance = metal.MembershipsApi(api_client)
    id = 'id_example' # str | Membership UUID
membership = metal.MembershipInput() # MembershipInput | Membership to update
