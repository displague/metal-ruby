# metal.OperatingSystemVersionsApi
...
with metal.ApiClient(configuration) as api_client:
    ...
    api_instance = metal.OperatingSystemVersionsApi(api_client)
    ...
    try:
        ...
        print("Exception when calling OperatingSystemVersionsApi->find_operating_system_version: %s\n" % e)
```
